...
function Dashboard() {
  return (
    <div className="dark chart-wrapper my-4 mx-12 h-screen  bg-background rounded-lg flex max-w-6xl flex-col flex-wrap items-start justify-center gap-6 p-6 sm:flex-row sm:p-8">
